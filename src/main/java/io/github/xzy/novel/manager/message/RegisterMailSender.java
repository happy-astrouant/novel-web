package io.github.xzy.novel.manager.message;

import io.github.xzy.novel.core.config.MailProperties;
import io.github.xzy.novel.core.constant.MessageSenderTypeConsts;
...
public class RegisterMailSender extends AbstractMailSender {
    ...
    protected String resolveContent(String content, Object... args) {
        ...
        String websiteLink = "https://www.xzy.com";
        String websiteEmail = "xzy@foxmail.com";
