package io.github.xzy.novel.core.json.serializer;
...
import io.github.xzy.novel.core.util.DesensitizedUtil;
import io.github.xzy.novel.core.util.StrUtils;
...
public class DesensitizationSerialize extends JsonSerializer<String> implements ContextualSerializer {
    ...
    public void serialize(String str, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        switch (type) {
            // 自定义类型脱敏
            case MY_RULE:
                jsonGenerator.writeString(StrUtils.hide(str, startInclude, endExclude));
                break;
            // userId脱敏
            case USER_ID:
                jsonGenerator.writeString(DesensitizedUtil.userId(str));
                break;
            // 中文姓名脱敏
            case CHINESE_NAME:
